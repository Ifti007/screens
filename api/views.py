...
#import json
import simplejson as json,math,decimal
...
def usertrack(request,page_num="1",page_size="20",search_str=None,order_by='pk'):
    ...
    if request.method == 'GET':
      ...
      logger.debug('total_row_count='+unicode(total_row_count))
      logger.debug('page_num='+unicode(page_num))
      ...
      s='{"meta":'+unicode(meta)+',"data":'+unicode(s)+'}'
